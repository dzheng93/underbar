(function() {
  ...
  _.uniq = function(array) {
    var acc = [];
      _.each(array, function(element, i) {
        var indexNum = _.indexOf(acc, element);
        if(indexNum === -1) {
          acc.push(element);
        }
      });
  ...
  _.reduce = function(collection, iterator, accumulator) {
      _.each(collection, function(element, i) {
        // if accumulator is not defined, first item in array will be the starting point.
        if (accumulator === undefined && i === 0) {
          accumulator = element;
        } else {
          // then iterate through the array and use the iterator on each array element.
  ...
  _.every = function(collection, iterator) {
    ...
    // if iterator is not defined, we will compare it to the identity function.
  ...
  _.shuffle = function(array) {
    ...
    var randArray = [];
      for(var i = 0; i < array.length; i++) {
        ...
        var randElem = newArray[randIndex];
        randArray.push(randElem);
